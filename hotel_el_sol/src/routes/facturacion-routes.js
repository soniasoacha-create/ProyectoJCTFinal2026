...
import { authenticate, requireAdmin } from '../middlewares/roleMiddleware.js';
import {
 ...
 */
router.post('/:id_reserva', authenticate, generarObtenerFactura);
 ...
 * @access Autenticado (Cliente o Admin)
 */
router.get('/completa/:id_reserva', authenticate, obtenerFacturaCompleta);
 ...
 */
router.get('/todas', authenticate, requireAdmin, listarTodasFacturas);
 ...
 */
router.get('/usuario/:id_usuario', authenticate, obtenerFacturasUsuario);
 ...
 * @access Autenticado (Cliente o Admin)
 */
router.get('/:id_factura', authenticate, obtenerFactura);
 ...
 * @access Solo Administrador
 */
router.put('/:id_factura/estado', authenticate, requireAdmin, cambiarEstadoFactura);
